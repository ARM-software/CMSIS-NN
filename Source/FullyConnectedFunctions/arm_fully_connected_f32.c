 ...
 * Title:        arm_fully_connected_f32.c
 * Description:  Fully connected function (float32)
 *
 * $Date:        19 March 2026
 * $Revision:    V.1.0.0
 *
...
static arm_cmsis_nn_status arm_fully_connected_core_f32(const cmsis_nn_context *ctx,
                                                        ...
                                                        float32_t *output)
{
    ...
    {
        return arm_nn_mat_mult_nt_n_packed_f32(input,
                                               kernel,
                                               bias,
                                               output,
                                               batch_cnt,
    ...
    return arm_nn_mat_mult_nt_t_f32(input,
                                    kernel,
                                    bias,
                                    output,
                                    batch_cnt,
                                                 ...
                                                 float32_t *output)
{
    ...
    return arm_fully_connected_core_f32(
                                            ...
                                            arm_nn_tensor_layout layout)
{
    ...
    return arm_fully_connected_nhwc_f32(
        ctx, fc_params, input_dims, input, filter_dims, kernel, bias_dims, bias, output_dims, output);
}
