 ...
 * Title:        arm_py_conv_buffer_size.cpp
 * Description:  Convolve wrapper buffer size pybinds (optional Python module)
 *
 * $Date:        23 Feb 2026
 * $Revision:    V.1.0.0
 *
...
static inline cmsis_nn_conv_params make_conv_params(const std::array<int32_t, 2> &padding_hw,
...
void conv_buffer_size(py::module_ &m)
{
    py::enum_<Backend>(m, "Backend")
        .value("MVE", Backend::MVE)
        .value("DSP", Backend::DSP)
        .value("SCALAR", Backend::SCALAR);
    py::enum_<DataType>(m, "DataType")
        .value("A8W4", DataType::A8W4)
        .value("A8W8", DataType::A8W8)
        .value("A16W8", DataType::A16W8);

    m.def(
        "convolve_wrapper_buffer_size",
        [](Backend backend,
           DataType data_type,
           ...
           int32_t activation_max) -> int32_t {
            const cmsis_nn_conv_params conv_params = make_conv_params(
                padding_hw, stride_hw, dilation_hw, input_offset, output_offset, activation_min, activation_max);
            ...
            case DataType::A8W4:
                ...
                {
                case Backend::MVE:
                    return arm_convolve_wrapper_s4_get_buffer_size_mve(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                case Backend::DSP:
                    return arm_convolve_wrapper_s4_get_buffer_size_dsp(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                case Backend::SCALAR:
                    return arm_convolve_wrapper_s4_get_buffer_size(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                }
                break;
            case DataType::A8W8:
                ...
                {
                case Backend::MVE:
                    return arm_convolve_wrapper_s8_get_buffer_size_mve(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                case Backend::DSP:
                    return arm_convolve_wrapper_s8_get_buffer_size_dsp(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                case Backend::SCALAR:
                    return arm_convolve_wrapper_s8_get_buffer_size(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                }
                break;
            case DataType::A16W8:
                ...
                {
                case Backend::MVE:
                    return arm_convolve_wrapper_s16_get_buffer_size_mve(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                case Backend::DSP:
                    return arm_convolve_wrapper_s16_get_buffer_size_dsp(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                case Backend::SCALAR:
                    return arm_convolve_wrapper_s16_get_buffer_size(
                        &conv_params, &input_dims, &filter_dims, &output_dims);
                }
                break;
            }
