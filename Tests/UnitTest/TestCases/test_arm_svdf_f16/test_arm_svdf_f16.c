...
#include "../TestData/svdf_batch2_f16/test_data.h"
#include "../TestData/svdf_match_1_f16/test_data.h"
#include "../TestData/svdf_match_2_f16/test_data.h"
#include "../TestData/svdf_small_f16/test_data.h"

#define RUN_SVDF_F16_CASE(CASE_PREFIX, case_name, tolerance)                                                           \
    void case_name##_arm_svdf_f16(void)                                                                                \
    {                                                                                                                  \
        float16_t state[CASE_PREFIX##_INPUT_BATCHES * CASE_PREFIX##_FEATURE_BATCHES * CASE_PREFIX##_TIME_BATCHES];     \
        float16_t scratch_input[CASE_PREFIX##_INPUT_BATCHES * CASE_PREFIX##_FEATURE_BATCHES];                          \
        float16_t scratch_output[CASE_PREFIX##_INPUT_BATCHES * CASE_PREFIX##_UNIT_COUNT];                              \
        ...
        const cmsis_nn_svdf_params_f16 params = {.rank = CASE_PREFIX##_RANK,                                           \
...
RUN_SVDF_F16_CASE(SVDF_SMALL_F16, svdf_small_f16, 8.0e-3f)
RUN_SVDF_F16_CASE(SVDF_BATCH2_F16, svdf_batch2_f16, 8.0e-3f)
RUN_SVDF_F16_CASE(SVDF_MATCH_1_F16, svdf_match_1_f16, 8.0e-3f)
RUN_SVDF_F16_CASE(SVDF_MATCH_2_F16, svdf_match_2_f16, 8.0e-3f)
