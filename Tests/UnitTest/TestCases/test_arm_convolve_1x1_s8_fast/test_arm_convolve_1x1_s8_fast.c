...
#include "../TestData/kernel1x1_null_bias/test_data.h"
...
void kernel1x1_arm_convolve_1x1_s8_fast_null_bias(void)
{
    const arm_cmsis_nn_status expected = ARM_CMSIS_NN_SUCCESS;
    int8_t output[KERNEL1X1_NULL_BIAS_DST_SIZE] = {0};
    ...
    const int32_t *bias_data = kernel1x1_null_bias_biases;
    const int8_t *input_data = kernel1x1_null_bias_input;

    input_dims.n = KERNEL1X1_NULL_BIAS_INPUT_BATCHES;
    input_dims.h = KERNEL1X1_NULL_BIAS_INPUT_H;
    input_dims.w = KERNEL1X1_NULL_BIAS_INPUT_W;
    input_dims.c = KERNEL1X1_NULL_BIAS_IN_CH;
    filter_dims.n = KERNEL1X1_NULL_BIAS_OUT_CH;
    filter_dims.h = KERNEL1X1_NULL_BIAS_FILTER_Y;
    filter_dims.w = KERNEL1X1_NULL_BIAS_FILTER_X;
    filter_dims.c = KERNEL1X1_NULL_BIAS_IN_CH;
    output_dims.n = KERNEL1X1_NULL_BIAS_INPUT_BATCHES;
    output_dims.h = KERNEL1X1_NULL_BIAS_OUTPUT_H;
    output_dims.w = KERNEL1X1_NULL_BIAS_OUTPUT_W;
    output_dims.c = KERNEL1X1_NULL_BIAS_OUT_CH;

    conv_params.padding.h = KERNEL1X1_NULL_BIAS_PAD_Y;
    conv_params.padding.w = KERNEL1X1_NULL_BIAS_PAD_X;
    conv_params.stride.h = KERNEL1X1_NULL_BIAS_STRIDE_Y;
    conv_params.stride.w = KERNEL1X1_NULL_BIAS_STRIDE_X;
    ...
    conv_params.input_offset = KERNEL1X1_NULL_BIAS_INPUT_OFFSET;
    conv_params.output_offset = KERNEL1X1_NULL_BIAS_OUTPUT_OFFSET;
    conv_params.activation.min = KERNEL1X1_NULL_BIAS_OUT_ACTIVATION_MIN;
    conv_params.activation.max = KERNEL1X1_NULL_BIAS_OUT_ACTIVATION_MAX;
    quant_params.multiplier = (int32_t *)kernel1x1_null_bias_output_mult;
    quant_params.shift = (int32_t *)kernel1x1_null_bias_output_shift;
    ...
    TEST_ASSERT_EQUAL(expected, result);
    TEST_ASSERT_TRUE(validate(output, kernel1x1_null_bias_output_ref, KERNEL1X1_NULL_BIAS_DST_SIZE));
}
